        ...
        <z:window style="padding:5px" apply="projectx.online.category.ListComposer">
            ...
            <z:grid id="grid" emptyMessage="${message(code:'emptyMessage',default:'No Record')}">
                <z:columns sizable="true">
                    <z:column label="${message(code: 'category.name.label', default: 'Name')}"/>
                    <z:column label="${message(code: 'category.admin.label', default: 'Admin')}"/>
                    <z:column label="${message(code: 'category.created.label', default: 'Created')}"/>
