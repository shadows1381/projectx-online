...
class ListComposer {
	...
	private rowRenderer = {Row row, Object id, int index ->
		...
		row << {
			...
			menubar (sclass:"z-menubar-hor-hierarchy-menu"){
				menu (label:'Actions') {
					menupopup {
						menuitem(label: g.message(code: 'default.button.group.label', default: 'Open Group'),image:"${fam.icon(name: 'group_go')}",href:g.createLink(controller: "person", action: 'list', id: id))
						menuitem(label: g.message(code: 'default.button.edit.label', default: 'Edit'),image:'/images/skin/database_edit.png',href:g.createLink(controller: "category", action: 'edit', id: id))
						menuitem(label: g.message(code: 'default.button.delete.label', default: 'Delete'), image: "/images/skin/database_delete.png", client_onClick: "if(!confirm('${g.message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}'))event.stop()", onClick: {
